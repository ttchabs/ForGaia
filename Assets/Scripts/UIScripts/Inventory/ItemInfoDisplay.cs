...
public class ItemInfoDisplay : MonoBehaviour
{
    ...
    public void MeleeDisplayFunction(WeaponScriptable meleeDescriptionInfo) 
    { 
        InfoPanel.SetActive(true);
        Name.text = $"{meleeDescriptionInfo.ItemName}";
        Description.text = $"{meleeDescriptionInfo.ItemDescription}";
    ...
    public void GunDisplayFunction(GunScriptable gunDescriptionInfo)
    {
        InfoPanel.SetActive(true);
        Name.text = $"{gunDescriptionInfo.ItemName}";
        Description.text = $"{gunDescriptionInfo.ItemDescription}";
